...
import ntou.soselab.swagger.neo4j.graph.PathGraph;
...
public class AllSwaggerTFIDF {
        ...
        for (String serviceFile : sDocFolder.list()) {
            ...
            try {
                ...
                if(document != null){
                    ...
                    Swagger swagger = new SwaggerParser().parse(document);
                    getResourceInformation(swagger, allDocWord);
                    getOperation(swagger, allDocWord);
                    File file = new File("D:/SwaggerTFIDFData/"+count+".txt");
    ...
    public void getResourceInformation(Swagger swagger, ArrayList<String> allDocWord) {
    ...
    public void getOperation(Swagger swagger, ArrayList<String> allDocWord) {
    ...
    private void getOperationInformation(io.swagger.models.Operation swaggerOperation, ArrayList<String> allDocWord) {
