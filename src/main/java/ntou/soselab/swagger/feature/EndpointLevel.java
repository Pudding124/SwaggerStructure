...
public class EndpointLevel {
    ...
    public ArrayList<String> parseSwaggerEndpoint(Swagger swagger, io.swagger.models.Operation swaggerOperation, String path){
    ...
    public ArrayList<String> checkInputFormatAndOutputFormat(Swagger swagger, io.swagger.models.Operation swaggerOperation, ArrayList<String> feture){
